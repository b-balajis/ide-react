...
//                   <h2>SORRY!</h2>
//                   <h3 className="font-weight-light">The page youre looking for was not found.</h3>
//                 </div>
//               </div>
...
const Error404 = () => {
  return (
    <div>
      <div>
        <div className="d-flex align-items-center text-center error-page bg-blue-500 pt-5 pb-4 h-100">
          <div className="row flex-grow">
            <div className="col-lg-8 mx-auto text-white">
              <div className="row align-items-center d-flex flex-row">
                <div className="col-lg-6 text-lg-right pr-lg-4">
